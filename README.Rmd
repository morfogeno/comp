...
- [`make.R`](https://github.com/morfogeno/comp/tree/main/make.R):
main R script to run the entire project

- [`R/`](https://github.com/morfogeno/comp/tree/main/R):
...
Launch the [`make.R`](https://github.com/morfogeno/comp/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/morfogeno/comp/blob/main/CONTRIBUTING.md).
